layui.config({
    base: '/myblog_template/static/easyCropper/' //layui自定义layui组件目录,根据自己具体项目结构而定
    ...
    var obj = {
        ...
        render: function(e){
            ...
            // 注意更改这里css的路径
            var cropperHtml = '<link rel="stylesheet" href="../../../myblog_template/static/easyCropper/cropper.css">\n' +
